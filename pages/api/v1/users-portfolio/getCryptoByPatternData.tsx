...
function getData(tokens: any, url: any | null, param: any | null, body: any | null) {
  let apiCall = getApiCall(tokens, url, "ups",param)
  let sendRes: {
    status: number,
    data: any,
    newToken: any
...
export default async function handler(
  ...
  let extraparams:any = req.query.data;
  console.log(req);
  console.log("request called");
  console.log(params);
  await getData(tokens, `search/currency/${extraparams}`, params, null).then((response: any) => {
    console.log("Response")
