...
import deleteApiCall from "../../../../components/deleteApiCall";
...
function getData(tokens: any, url: any | null, param: any | null, body: any | null) {
  let apiCall = deleteApiCall(tokens, url, "ups",param)
  let sendRes: {
    status: number,
    data: any,
    newToken: any
...
export default async function handler(
  ...
  let params: any = req.query.accountToDelete;
  console.log(req);
  console.log("request called");
  console.log(params);
  console.log(tokens);
  await getData(tokens, `account/${params}`, null, null).then((response: any) => {
    console.log("Response")
