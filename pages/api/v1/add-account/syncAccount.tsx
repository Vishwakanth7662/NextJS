...
function getData(tokens: any, url: any | null, param: any | null, body: any | null) {
    console.log("url");
    console.log(url);
    let apiCall = postApiCall(tokens, url, null, 'ups');
    let sendRes: {
        status: number,
        data: any,
        newToken: any
...
export default async function handler(
    ...
    let paramsAccount: any = req.query.accountoSync
    await getData(tokens, `sync/account/${paramsAccount}`, null, null).then((response: any) => {
        console.log("Response")
